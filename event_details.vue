                    ...
                    <div  v-if="currentEvent">
                        ...
                        <div class="row margin_60">
                            <div class="col-md-12">
                                ...
                                <social-sharing v-if="currentEvent" :url="shareURL(currentEvent.slug)" :title="currentEvent.name" :description="currentEvent.description" :quote="truncate(currentEvent.description)" :twitter-user="siteInfo.twitterHandle" :media="currentEvent.image_url" @open="open()" @change="change()" @close="close()" inline-template>
                ...
                currentEvent : function (){
                    if(this.currentEvent != null) {
                        if (this.currentEvent.eventable_type === "Store"){
                            ...
                            if (_.includes(this.currentEvent.event_image_url_abs, 'missing')) {
                                this.currentEvent.image_url = "//codecloud.cdn.speedyrails.net/sites/5d700e9c6e6f647c7f750000/image/png/1529532187000/eventsplaceholder2@2x.png";    
                            }
                        }
                    }
                }
