                                    ...
                                    <div class="store_logo_container">
                                        <router-link :to="'/stores/'+ store.slug">
                                            <div v-if="!store.no_store_logo">
                                                <img class="transparent_logo" src="//codecloud.cdn.speedyrails.net/sites/5d700e9c6e6f647c7f750000/image/png/1536094188000/default_background.png">
                                                <img  class="store_img" :src="store.store_front_url_abs" alt="">
                                            </div>
                                            
                                            <div v-else class="no_logo_container">
                                                <img class="transparent_logo" src="//codecloud.cdn.speedyrails.net/sites/5d700e9c6e6f647c7f750000/image/png/1536094188000/default_background.png" alt="">
            ...
            computed: {
                ...
                allStores() {
                    ...
                    _.forEach(this.processedStores, function(value, key) {
                        if(_.includes(value.categories, vm.dineFilter)) {
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5d700e9c6e6f647c7f750000/image/png/1534781683000/longbeach_default.png";
                            }
                            store_list.push(value);
                        }
                    });
