                ...
                <div class="main_container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>In the heart of Long Beach, The Long Beach Towne Center is located at 7575 Carson Blvd, Long Beach, CA 90808</p>
                        </div>
                    </div>
                </div>
		...
		return Vue.component("location-component", {
            ...
            methods: {
                loadData: async function () {
                    ...
                    try {
                        let results = await Promise.all([this.$store.dispatch("getData", "repos"), this.$store.dispatch('LOAD_PAGE_DATA', {url: this.property.mm_host + "/pages/longbeach-location.json"})]);
                        return results;
                    } catch (e) {
