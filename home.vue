        ...
        return Vue.component("home-component", {
            ...
            computed: {
                ...
                featuredItems() {
                    ...
                    _.forEach(this.processedPromos, function(value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5b71e1e76e6f6411c4060000/image/png/1529532181000/promoplaceholder2@2x.png";
                            }
                    ...
                    _.forEach(this.processedEvents, function(value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5b71e1e76e6f6411c4060000/image/png/1529532187000/eventsplaceholder2@2x.png";
                            }
            ...
            methods: {
                loadData: async function() {
                    try {
                        let results = await Promise.all([this.$store.dispatch("getData", "banners"), this.$store.dispatch("getData","promotions"), this.$store.dispatch("getData", "events"), this.$store.dispatch('LOAD_PAGE_DATA', {url: "https://longbeach.mallmaverick.com/api/v4/longbeach/social.json"})]);
                        return results;
                    } catch(e) {
